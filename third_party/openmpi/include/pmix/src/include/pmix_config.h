...
#define PACKAGE_STRING "pmix 5.0.10"
...
#define PMIX_CC "/usr/bin/clang"

/* Capture the configure cmd line */
#define PMIX_CONFIGURE_CLI " \'--disable-option-checking\' \'--prefix=/Users/xuming/software/mpi-5.0/install\' \'--without-tests-examples\' \'--enable-pmix-binaries\' \'--disable-pmix-backward-compatibility\' \'--disable-visibility\' \'--disable-devel-check\' \'--with-libevent\' \'--disable-libevent-lib-checks\' \'--with-libevent-extra-libs=/Users/xuming/software/mpi-5.0/build/3rd-party/libevent-2.1.12-stable-ompi/libevent_core.la /Users/xuming/software/mpi-5.0/build/3rd-party/libevent-2.1.12-stable-ompi/libevent_pthreads.la\' \'--disable-hwloc-lib-checks\' \'--with-hwloc-extra-libs=/Users/xuming/software/mpi-5.0/build/3rd-party/hwloc-2.7.1/hwloc/libhwloc.la\' \'--with-wrapper-libs=-levent_core -levent_pthreads \' \'--disable-mpi-fortran\' \'CC=/usr/bin/clang\' \'CPPFLAGS=-I/Users/xuming/software/mpi-5.0/build/3rd-party/libevent-2.1.12-stable-ompi -I/Users/xuming/software/mpi-5.0/build/3rd-party/libevent-2.1.12-stable-ompi/include -I/Users/xuming/software/mpi-5.0/build/3rd-party/hwloc-2.7.1/include -I/Users/xuming/software/mpi-5.0/openmpi-5.0.10/3rd-party/hwloc-2.7.1/include\' \'CXX=/usr/bin/clang++\' \'--cache-file=/dev/null\' \'--srcdir=../../../openmpi-5.0.10/3rd-party/openpmix\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "Tue Sep  1 10:33:23 UTC 2026"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "Mac.mshome.net"

/* User who built PMIx */
#define PMIX_CONFIGURE_USER "xuming"
...
#define PMIX_PACKAGE_STRING "PMIx xuming@Mac.mshome.net Distribution"
...
#define PMIX_RELEASE_VERSION 10

/* The OpenPMIx Git Revision */
#define PMIX_REPO_REV "v5.0.10"
