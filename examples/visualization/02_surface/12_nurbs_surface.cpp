...
int main(int argc, char** argv)
{
    ...
    surface::NURBSSurface3d patch(
        2, 2,
        {0,0,0,1,2,2,2},
        {0,0,0,1,2,2,2},
        {
            {{0,0,0},{0,1,0.2},{0,2,0.2},{0,3,0}},
            {{1,0,0.2},{1,1,1.0},{1,2,1.0},{1,3,0.2}},
            {{2,0,0.2},{2,1,1.0},{2,2,1.0},{2,3,0.2}},
            {{3,0,0},{3,1,0.2},{3,2,0.2},{3,3,0}}
        },
        {
            {1,1,1,1},
            {1,2.5,2.5,1},
    ...
    options.title = "NURBS Surface - Increased Center Weights";
    if (argc > 1 && std::string(argv[1]) == "--save")
    {
        options.show = false;
        options.output_path = "nurbs_surface.png";
    }
